 ...
 * @return 成功時0、エラー時-1
 */
__attribute__((nonnull(1, 2))) static inline int get_ntp_timestamp(uint32_t *sec, uint32_t *frac)
{
#ifdef _WIN32
 ...
 * @return UNIX時刻（秒）
 */
__attribute__((pure)) static inline double ntp_to_double(uint32_t sec, uint32_t frac)
{
 ...
 * @return 成功時0、エラー時-1
 */
__attribute__((nonnull(1, 2))) static inline int parse_port(const char *arg, uint16_t *port)
{
	char *end = NULL;
	unsigned long value;
 ...
 */
__attribute__((nonnull(1, 2, 3))) static inline bool extract_kernel_timestamp_windows(WSAMSG *msg,
										      uint32_t *ntp_sec,
										      uint32_t *ntp_frac)
{
 ...
 */
__attribute__((nonnull(1, 2, 3))) static inline bool extract_kernel_timestamp_linux(struct msghdr *msg,
 ...
 * @return 構造体サイズ
 */
__attribute__((const)) static inline socklen_t get_sockaddr_len(int family)
{
 ...
 */
__attribute__((nonnull(1, 2))) static inline const char *sockaddr_to_string(const struct sockaddr_storage *addr,
 ...
 * @return 成功時0、エラー時-1
 */
__attribute__((nonnull(1, 4, 5))) static inline int resolve_address(const char *host, uint16_t port, int af_hint,
